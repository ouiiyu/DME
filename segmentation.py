...
# ---------------------------------------------------------------a
### 保存结果的函数
def save_prediction(image, mask_true, mask_pred, epoch, batch_idx, img_idx, save_dir="/media/disk/Backup/03drive/03SJY/segmentation/hard_exduates2/desnet161/save"):
...
def save_metrics_to_txt(epoch, train_logs, valid_logs, save_path='/media/disk/Backup/03drive/03SJY/segmentation/hard_exduates2/desnet161/table.txt'):
...
if __name__ == '__main__':
    x_train_dir = r'/media/disk/Backup/03drive/03SJY/re_hd/Testing_Images'
    y_train_dir = r'/media/disk/Backup/03drive/03SJY/re_hd/Testing_Labels'
    x_valid_dir = r'/media/disk/Backup/03drive/03SJY/re_hd/Testing_Images'
    y_valid_dir = r'/media/disk/Backup/03drive/03SJY/re_hd/Testing_Labels'
    ENCODER = 'densenet161'
...
#指标
    ...
    for epoch in range(0, 75):
        ...
        if max_score < valid_logs['iou_score']:
            ...
            torch.save(model, '/media/disk/Backup/03drive/03SJY/segmentation/hard_exduates2/desnet161/model.pth')
            print('Model saved!')
