...
dataset_path_0 = '/media/disk/Backup/03drive/02LMW/from02drive/dme/cutmodel/mask/combined_end/0'
dataset_path_1 = '/media/disk/Backup/03drive/02LMW/from02drive/dme/cutmodel/mask/combined_end/1'
...
# 输出文件和图像保存路径
output_dir_metrics = '/media/disk/Backup/03drive/02LMW/from02drive/dme/agg/resnet50_/weights_metrics'
output_dir_visualizations = '/media/disk/Backup/03drive/02LMW/from02drive/dme/agg/resnet50_/visual'
